#Making a Question Game whit a API request
...
print(question["results"][0]["category"]) # Entertainment: Music
print(question["results"][0]["incorrect_answers"]) # ['Oboe', 'Trombone', 'Duduk']
#-------------------------
# Dictionary in Format JSON
...
while endGame != "quit":
    ...
    if(r.status_code != 200):
      endGame = input("Sorry, there was a problem retrieving the question. Press enter to try again or write \"Quit\" to quit the game." )
    else:
      valid_answer = False
      answer_number = 1
      ...
      if user_answer == correct_answer:
        print("\nCongrats! You answerd correctly! The correct answer was: " + html.unescape(correct_answer))
        score_correct += 1
      else:
      ...
      print("\n#######################")
      endGame = input("Press enter to play again or write \"Quit\" to quit the game. ").lower()
